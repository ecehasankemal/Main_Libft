...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/06 11:42:48 by hece              #+#    #+#             */
/*   Updated: 2023/01/06 11:43:42 by hece             ###   ########.tr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_itoa_base(unsigned long long nbr, int base, char *str, int mod)
{
	int	nbr_list[100];
	int	index;
	int	len;
...
static int	ft_check_format(va_list args, char format)
{
	int	len;
